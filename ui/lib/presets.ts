 ...
 * Anthropic (Claude), OpenAI API (Codex), Gemini, Groq, Mistral, Together,
 * Fireworks, Venice, CodeFast, Kadirr.Dev (Codex), Yunwu, DeepSeek, Kimi,
...
export const CLAUDE_PRESETS: ProviderPreset[] = [
  ...
  },
  {
    ...
    auth_style: "api_key",
    note: "Official Anthropic API — opus-4-8, sonnet-5, fable-5, sonnet-4-6/4-5, haiku-4-5",
    tint: "#D97757",
  },
  {
    id: "codefast",
...
export const CODEX_PRESETS: ProviderPreset[] = [
  ...
  },
  {
    ...
    model: "gemini-3-pro",
    wire_api: "chat",
    note: "Google's OpenAI-compatibility endpoint",
    tint: "#4285F4",
  },
  {
    id: "groq",
    ...
    wire_api: "chat",
    note: "Groq's OpenAI-compatible endpoint",
    tint: "#F55036",
  },
  {
    id: "mistral",
    ...
    wire_api: "chat",
    note: "Mistral's OpenAI-compatible endpoint",
    tint: "#FA500F",
  },
  {
    id: "together",
    ...
    wire_api: "chat",
    note: "Together AI's OpenAI-compatible endpoint",
    tint: "#0F6FFF",
  },
  {
    id: "fireworks",
    ...
    wire_api: "chat",
    note: "Fireworks AI's OpenAI-compatible endpoint",
    tint: "#9D0CFF",
  },
  {
    id: "venice",
    ...
    wire_api: "chat",
    note: "Venice AI's OpenAI-compatible endpoint",
    tint: "#14B8A6",
  },
  {
    id: "codefast",
